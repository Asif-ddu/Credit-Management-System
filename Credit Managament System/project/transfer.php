...
$result = mysqli_query($conn, "SELECT name FROM users ORDER BY id"); 
?>
<!DOCTYPE HTML>
<HTML>
<head>
...
<body>
	...
	<nav class="navbar navbar-default">
      ...
      <a class="navbar-brand" href="#">
      	<span><img alt="Brand" src="http://localhost/project/logo.png" width="90" height="90" style="position: absolute;top:0%;"></span>
      </a>
      <ul class="nav navbar-nav">
      <li class="active" style="position: absolute;left:10%;top:15%;font-size:20px;"><a href="index.html">Home</a></li>
      <li style="position: absolute;left:15%;top:15%;font-size:20px;"><a href="http://localhost/project/transfer.php">Transfer Credits</a></li>
    </ul>
    </div>
  </div>
</nav>
...
<div class="add">
  <a href="http://localhost/project/add_user.php"><H5>Add a user by clicking here</H5></a></div>
</body>