<?php
	ini_set('error_reporting',E_ALL & ~E_NOTICE );
		...
		$credit = $_POST['credit'];
					    ...
					    $result="INSERT INTO `users`(`name`, `id`, `email`, `credit`) VALUES (?,?,?,?)";
				...
				if(isset($_POST['submit'])){
					...
					include('pdo.php');
					$sql="DELETE FROM users WHERE email is :zip";
...
<body>
	<h1>Add User</h1>
	<img alt="Brand" src="http://localhost/project/logo.png" width="100" height="100" style="position: absolute;top:-1.5%;left:10%;">
	<div class="form">
		<form method="Post" action="add_user.php">
			...
			<input type="submit" name="submit" value="Add user" class="submitt">
			<br><br>
